...
if (isset($_POST['update_order'])) {
   ...
   $date = date("d.m.Y");
   mysqli_query($conn, "UPDATE `confirm_order` SET payment_status = '$update_payment',date='$date' WHERE id = '$order_update_id'") or die('query failed');
   $message[] = 'payment status has been updated!';
}

if (isset($_GET['delete'])) {
   $delete_id = $_GET['delete'];
   mysqli_query($conn, "DELETE FROM `confirm_order` WHERE id = '$delete_id'") or die('query failed');
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> Order Id : <span>#<?php echo $fetch_book['id']; ?> </p>
                  ...
                  <form action="" method="post">
                     <input type="hidden" name="order_id" value="<?php echo $fetch_book['id']; ?>">
                     ...
                     <a class="cart-btn1" href="admin_orders.php?delete=<?php echo $fetch_book['id']; ?>" onclick="return confirm('delete this order?');">delete</a>
                  </form>
               </div>
         <?php
            }
