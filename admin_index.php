  ...
  <body>
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Total Pendings</h5>
          <p class="card-text"> ₹ 
      ...
      <?php
         ...
         ?>
        <img class="card-img-top" src="./images/rup.png" alt="Card image cap" />
        <div class="card-body">
      ...
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/book_cart.png" alt="Card image cap" />
        <div class="card-body">
      ...
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/msg.png" alt="Card image cap" />
        <div class="card-body">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Total Registeration</h5>
          <p class="card-text">
            <?php echo $usercount; ?>
          </p>
          <a href="users_detail.php" class="btn btn-primary">Details</a>
