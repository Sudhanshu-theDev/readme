...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Payment status : <span style="color:<?php if($fetch_book['payment_status'] == 'pending'){ echo 'brown'; }else{ echo 'green'; } ?>;"><?php echo $fetch_book['payment_status']; ?></span> </p>
         <p><a href="invoice.php?order_id=<?php echo $fetch_book['id']; ?>" target="_blank">Print Recipt</a></p>
         </div>
