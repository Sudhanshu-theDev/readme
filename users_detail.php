...
<body>
    ...
    ?>
    <a class="update_btn" style="position: fixed ; z-index:100;" href="./download_data/users_data.php">Print</a>
   ...
   <div class="box">
      ...
      <div class="price" style="color:<?php if($fetch_user['user_type'] == 'Admin'){ echo 'red'; }else{ echo 'brown'; } ?>;">User type: <?php echo $fetch_user['user_type']; ?></div>
      <a href="users_detail.php?update_user=<?php echo $fetch_user['Id']; ?>">Update</a>
