...
<body>
  ...
  <h2 style="text-align: center; margin-top:15px;">Place Your Order Here</h2>
        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="fname" name="firstname" placeholder="Sudhanshu Gupta">
              ...
              <input type="text" id="email" name="number" placeholder="9567985415">
              <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
              <input type="text" id="adr" name="address" placeholder="5 B-ward BMC Colony">
              ...
              <div style="padding: 0px;" class="row">
                ...
                <div class="col-50">
                  ...
                  <input type="text" id="zip" name="pincode" placeholder="212402">
                </div>
              </div>
            </div>
